  ...
  return (
    <main className="min-h-screen flex items-center justify-center">
      <div className="container flex flex-col items-center gap-8 border border-blue-100 dark:border-gray-700 backdrop-blur">
        ...
        <p
          className="text-base md:text-lg text-left leading-relaxed w-full"
          style={{ color: 'var(--foreground)' }}
        >
          Hello! I&apos;m a software engineer passionate about frontend
          development.
          <br />
          I love building modern, user-friendly web applications and exploring
          new technologies.
          <br />
          <span
